...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.core = new core_1.default(this.spec, 'apis-chile/unknown (api/6.1.3)');
    }
    /**
    ...
    /**
     * Servicios para pruebas de consulta información de un vehículo sólo con su patente.
     *
     * @summary Patentes (testing)
     */
    SDK.prototype.carPlateTesting = function (metadata) {
        return this.core.fetch('/vehicle/fake/{plate}.json', 'get', metadata);
    };
    /**
     ...
     * @summary Comunas
     */
    SDK.prototype.geographyCommunes = function () {
        return this.core.fetch('/geography/communes.json', 'get');
    };
    /**
     ...
     * @summary Regiones
     */
    SDK.prototype.geographyRegions = function () {
        return this.core.fetch('/geography/regions.json', 'get');
    };
    /**
     ...
     * @summary Provincias
     */
    SDK.prototype.geographyProvinces = function () {
        return this.core.fetch('/geography/provinces.json', 'get');
    };
    /**
     * Permite saber si una patente transitó por alguna autopista o carretera sin un TAG
     * vigente.
     *
     * @summary 🔐 Pasos por pórticos sin TAG
     */
    SDK.prototype.carCheck_crossings_without_tags = function (metadata) {
        return this.core.fetch('/vehicle/check_crossings_without_tags/{plate}.json', 'get', metadata);
    };
    /**
     * Permite obtener la deuda total vigente de TAG que tiene una persona o empresa.
     *
     * @summary 🔐 Deuda total TAG
     */
    SDK.prototype.carTag = function (metadata) {
        return this.core.fetch('/vehicle/tag/{rut}.json', 'get', metadata);
    };
    /**
     * Obtiene todas las marcas de vehículos en Chile reconocidas antes el Servicio de
     * Impuestos Internos
     *
     * @summary Marcas
     */
    SDK.prototype.carBrands = function () {
        return this.core.fetch('/data/brands.json', 'get');
    };
    /**
     * Obtiene todos los modelos de vehículos en Chile reconocidas antes el Servicio de
     * Impuestos Internos
     *
     * @summary Modelos
     */
    SDK.prototype.carBrandsModels = function (metadata) {
        return this.core.fetch('/data/models.json', 'get', metadata);
    };
    /**
     * Obtiene todas las versiones de un modelo específico de vehículo en Chile reconocidas
     * antes el Servicio de Impuestos Internos
     *
     * @summary Versiones
     */
    SDK.prototype.carBrandsModelsVersions = function (metadata) {
        return this.core.fetch('/data/versions.json', 'get', metadata);
    };
    /**
     * Permite obtener la deuda total vigente de TAG que tiene una persona o empresa.
     *
     * @summary 🔐 Recalls
     */
    SDK.prototype.carRecalls = function (metadata) {
        return this.core.fetch('/vehicle/recalls/{vin}.json', 'get', metadata);
    };
    /**
     * Permite obtener un listado actualizado de vehículos asociados al RUT.
     *
     * @summary 🔐 Buscar por RUT
     */
    SDK.prototype.carFindByDocument_number = function (metadata) {
        return this.core.fetch('/vehicle/find_by_document/{rut}.json', 'get', metadata);
    };
    return SDK;
}());
