...
declare class SDK {
     ...
     */
    carPlateTesting(metadata: types.CarPlateTestingMetadataParam): Promise<FetchResponse<200, types.CarPlateTestingResponse200>>;
    /**
     * Todas las comunas de Chile
     *
     * @summary Comunas
     */
    geographyCommunes(): Promise<FetchResponse<200, types.GeographyCommunesResponse200>>;
    /**
     * Todas las regiones de Chile
     *
     * @summary Regiones
     */
    geographyRegions(): Promise<FetchResponse<200, types.GeographyRegionsResponse200>>;
    /**
     * Todas las provincias de Chile
     *
     * @summary Provincias
     */
    geographyProvinces(): Promise<FetchResponse<200, types.GeographyProvincesResponse200>>;
    /**
     ...
     */
    carCheck_crossings_without_tags(metadata: types.CarCheckCrossingsWithoutTagsMetadataParam): Promise<FetchResponse<200, types.CarCheckCrossingsWithoutTagsResponse200>>;
    /**
     * Permite obtener la deuda total vigente de TAG que tiene una persona o empresa.
     *
     * @summary 🔐 Deuda total TAG
     */
    carTag(metadata: types.CarTagMetadataParam): Promise<FetchResponse<200, types.CarTagResponse200>>;
    /**
     ...
     * @summary Marcas
     */
    carBrands(): Promise<FetchResponse<200, types.CarBrandsResponse200>>;
    /**
     ...
     * @summary Modelos
     */
    carBrandsModels(metadata?: types.CarBrandsModelsMetadataParam): Promise<FetchResponse<200, types.CarBrandsModelsResponse200>>;
    /**
     ...
     * @summary Versiones
     */
    carBrandsModelsVersions(metadata?: types.CarBrandsModelsVersionsMetadataParam): Promise<FetchResponse<200, types.CarBrandsModelsVersionsResponse200>>;
    /**
     * Permite obtener la deuda total vigente de TAG que tiene una persona o empresa.
     *
     * @summary 🔐 Recalls
     */
    carRecalls(metadata: types.CarRecallsMetadataParam): Promise<FetchResponse<200, types.CarRecallsResponse200>>;
    /**
     * Permite obtener un listado actualizado de vehículos asociados al RUT.
     *
     * @summary 🔐 Buscar por RUT
     */
    carFindByDocument_number(metadata: types.CarFindByDocumentNumberMetadataParam): Promise<FetchResponse<200, types.CarFindByDocumentNumberResponse200>>;
}
